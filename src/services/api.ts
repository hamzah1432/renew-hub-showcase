...
export const postsApi = {
  async getPosts(limit: number = 4): Promise<Post[]> {
    try {
      // Fetch posts with embedded media and author data
      ...
      const posts: Post[] = wordpressPosts.map((wpPost) => {
        let featuredImage = "https://images.unsplash.com/photo-1509391366360-2e959784a276?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2072&q=80";
        ...
        return {
          ...
          link: wpPost.link,
          author: {
            name: "Professional Institute", // Default author name
