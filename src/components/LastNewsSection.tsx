    ...
    <section className="py-12 md:py-16 lg:py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center animate-fade-up" style={{ animationDelay: '0.5s' }}>
          <Button 
            size="lg" 
            className="border-2 border-primary text-primary bg-primary/90 hover:bg-primary/90 hover:text-white px-6 md:px-8 py-2 md:py-3 text-base md:text-lg font-semibold group"
